...
accordionsToggle(accordionTrigger, accordionBody); // Scroll to #
...
const video = document.querySelector('.play-video'); // Get the button that opens the modal

const btn = document.querySelectorAll(".navbar-perezvon");
const btn2 = document.getElementById("btn2");
const btn3 = document.getElementById("btn3");
const btn4 = document.getElementById("play"); // Get the <span> element that closes the modal
